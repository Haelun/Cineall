...
// The web address where this project runs.
// On XAMPP, if the project folder is  htdocs/cineall , this is correct.
// If you put it somewhere else, just change this one line.
...
/**
 * Call this at the top of any API file.
 * These files send back JSON (plain data), not a normal web page, so we:
 *   - tell the browser the reply is JSON, and
 *   - turn off printing PHP warnings (so they can't mix into the JSON).
 * Each API file also wraps its work in try/catch to report problems as JSON.
 */
