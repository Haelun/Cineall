            ...
            <div class="card mt-lg" style="background: rgba(244,239,230,0.02);">
                ...
                <div style="font-family: var(--font-mono); font-size: 11px; color: var(--text-muted);">
                    <div style="margin-bottom: 4px;">
                        <button type="button" onclick="fillTestCredentials('user@cineall.com', 'password123')"
                                class="verify-link" style="margin-right: 8px;">Fill</button>
                        user@cineall.com / password123
                        <span class="badge badge-primary" style="margin-left: 8px;">User</span>
                    </div>
                    <div style="margin-bottom: 4px;">
                        <button type="button" onclick="fillTestCredentials('admin@cineall.com', 'password123')"
                                class="verify-link" style="margin-right: 8px;">Fill</button>
                        admin@cineall.com / password123
                        <span class="badge badge-curator" style="margin-left: 8px;">Admin + 2FA</span>
                    </div>
                    <div>
                        <button type="button" onclick="fillTestCredentials('curator@cineall.com', 'password123')"
                                class="verify-link" style="margin-right: 8px;">Fill</button>
                        curator@cineall.com / password123
                        <span class="badge badge-curator" style="margin-left: 8px;">Curator + 2FA</span>
                    </div>
                </div>
            </div>
            <?php endif; ?>
